...
public class Errores extends javax.swing.JFrame {
    ...
    public Errores() {
        initComponents();
        this.setTitle("RoboKit - Errores");
        this.setResizable(false);
    }
    
    public JTable TablaL(){
        return Lexico;
    }
    ...
    private void initComponents() {
        ...
        Lexico = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));

        Lexico.setBackground(new java.awt.Color(242, 242, 242));
        Lexico.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
    ...
    private javax.swing.JTable Lexico;
